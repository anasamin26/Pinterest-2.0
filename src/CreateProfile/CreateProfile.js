...
export default function CreateProfile() {
  ...
  return (
    <div className="mt-5 edit-container container">
      <h3>
        <b>Create Profile</b>
      </h3>
        ...
        <div className="row mt-3">
          ...
          <div class="form-group col-md-6">
            ...
            <input
              ...
              onChange={(e) =>
                setPublicProfile({ ...publicProfile, lastName: e.target.value })
              }
        ...
        <div class="form-group mt-3">
          ...
          <div class="form-group">
            ...
            <input
              ...
              onChange={(e) =>
                setPublicProfile({ ...publicProfile, website: e.target.value })
              }
          ...
          <div class="form-group mt-3 my-5">
            ...
            <input
              ...
              onChange={(e) =>
                setPublicProfile({ ...publicProfile, username: e.target.value })
              }
              placeholder="Username"
            />
            <p
              className="text-muted footer-margin"
              style={{ fontSize: "11px" }}
            >
